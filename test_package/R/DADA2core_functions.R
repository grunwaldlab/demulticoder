...
#'
#' @examples
assign_taxonomyDada2<-function(abund_asv_table, ref_database, taxresults_file, minBoot=50, tryRC=FALSE, outputBootstraps=FALSE, verbose=FALSE, multithread=FALSE){
