...
directory_path<-"~/Documents/GitHub/rps10_metabarcoding_tool/WindRiver_test_mas/" ##choose a directory for all downstream steps
...
cutadapt_path<- "Users/phanhung2/.local/bin/cutadapt"
