---
title: "Demulticoder Example Workflow"
...
### Now we demonstrate how to make a heattree using taxmap object. First we make a heat tree for our 16S-barcoded samples 
```{r Heatree demonstration 16s , message=FALSE}
load("~/output_test_dataset/obj_dada_sixteenS.RData") 
obj_dada_16s<-obj_dada

heat_tree(obj_dada_16s,
...
### Now we demonstrate how to make a heattree using taxmap object. First we make a heat tree for our rps10-barcoded sample
```{r Heatree demonstration rps10, message=FALSE}
load("~/output_test_dataset/obj_dada_rps10.RData") 
...
load("~/output_test_dataset/obj_dada_its.RData") 
...
```{r Phyloseq demonstration 16S, message=FALSE}
load("~/output_test_dataset/phylo_obj_sixteenS.RData") 
phylo_data_16s<-phylo_obj
...
load("~/output_test_dataset/phylo_obj_its.RData") 
...
load("~/output_test_dataset/phylo_obj_rps10.RData") 
...
Finally, let's retrieve the packages we used and the versions
```{r}
