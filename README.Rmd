...
While some users will appreciate having a matrix with all ASVs, sequences, taxonomic assignments and abundances of each ASV per sample, others may prefer to reformat matrices into Phyloseq or Taxmap objects. 

Two wrapper functions are shared. They are derived from Metacoder function 'xx'.
