...
- The package handles not just 16S or ITS datasets when using default UNITE fungal or Silva 16S databases but also oomycete rps10 analyses using oomycetedb [https://grunwaldlab.github.io/OomyceteDB/](https://grunwaldlab.github.io/OomyceteDB/), or up to two custom databases (provided they are formatted as described here: https://benjjneb.github.io/dada2/training.html).
...
For more information on source code, check out the package repository: https://github.com/grunwaldlab/demulticoder/
