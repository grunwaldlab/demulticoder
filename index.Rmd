...
output<-prepare_reads(
  data_directory = "<DATADIR>", # This allows us to use the test dataset loaded within the package
  output_directory = "<OUTDIR>") # Change to you preferred location on your local computer
```
