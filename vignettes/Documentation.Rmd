...
This documentation provides comprehensive information on how to use the *demulticoder* R package for processing and analyzing metabarcode sequencing data. It covers input directory and file requirements, parameter settings, and key parameters.  
...
* **primer_name**: Name of the primer used (e.g., rps10, its, r16S, other1, other2)
