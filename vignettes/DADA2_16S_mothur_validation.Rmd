...
```{r download_files, warning=FALSE, message=FALSE}
...
```{r rename_files, warning=FALSE, message=FALSE}
...
```{r, data_directory_setup, warning=FALSE, message=FALSE}
data_folder <- file.path(destination_folder,"MiSeq_SOP") 
```
...
*metadata.csv file*
```{r metadata_1, warning=FALSE, message=FALSE}
metadata <- data.frame(
...
```{r metadata_2, warning=FALSE, message=FALSE}
...
```{r, metadata_csv, echo=FALSE, message=FALSE}
print(metadata)
```
...
I referenced the DADA2 [tutorial](https://benjjneb.github.io/dada2/tutorial.html) to select the same parameter options.  
...
```{r primerinfo_params_file, warning=FALSE, message=FALSE}
...
```{r download_db, warning=FALSE, message=FALSE}
...
```{r prepare_reads, fig.height=6, fig.width=6, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r Remove_primers_and_trim_reads, fig.height=6, fig.width=6, message=FALSE, warning=FALSE, cache=TRUE}
cut_trim(
  output,
...
```{r visualize_outputs_cut_trim, echo=FALSE, fig.height=6, fig.width=6, message=FALSE, cache=TRUE}
...
```{r ASV_inference, fig.height=6, fig.width=6, warning=FALSE, message=FALSE, cache=TRUE}
...
```{r visualize_outputs_asv_inf1, fig.height=10, fig.width=10, echo=FALSE, message=FALSE, cache=TRUE}
if (!overwrite_existing) {
...
```{r visualize_outputs_asv_inf2, fig.height=10, fig.width=10, echo=FALSE, message=FALSE, cache=TRUE}
if (!overwrite_existing) {
...
```{r assign_taxonomy_step, fig.height=6, fig.width=6, echo=TRUE, message=FALSE, warning=FALSE, cache=TRUE}
assign_tax(
  output,
  asv_abund_matrix,
...
```{r view_read_counts, fig.height=10, fig.width=10, echo=FALSE, message=FALSE}
...
```{r convert_matrix_to_other_formats, fig.height=6, fig.width=6, message=FALSE, cache=TRUE}
...
```{r examine_accuracy, fig.height=6, fig.width=6, message=FALSE, cache=TRUE}
...
```{r phyloseq_alpha_diversity_analysis, fig.height=6, fig.width=6, echo=TRUE, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r phyloseq_beta_diversity_analysis, fig.height=8, fig.width=8, echo=TRUE, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r phyloseq_community_analysis, fig.height=8, fig.width=8, echo=TRUE, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r session_info, message=FALSE, cache=TRUE}
sessionInfo()
```