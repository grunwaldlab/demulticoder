...
```{r phyloseq_alpha_diversity_analysis, fig.height=6, fig.width=6}
...
```{r phyloseq_beta_diversity_analysis, fig.height=6, fig.width=6}
...
```{r phyloseq_community_analysis, fig.height=5, fig.width=8}
