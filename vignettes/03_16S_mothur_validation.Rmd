...
outputs<-prepare_reads(
  data_directory = "~/demulticoder_benchmarking/mothur_16S_sop/data", 
  output_directory = "~/demulticoder_benchmarking/mothur_16S_sop/data",
...
tax_matrix<-read.csv("~/benchmark_demulticoder/mothur_16S_sop/data/final_asv_abundance_matrix_r16S.csv")
...
#load objs if not running whole pipeline
load("~/benchmark_demulticoder/mothur_16S_sop/data/phylo_obj_r16S.RData")
load("~/benchmark_demulticoder/mothur_16S_sop/data/taxmap_obj_r16S.RData")
