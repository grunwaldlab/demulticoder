...
outputs<-prepare_reads(
  ...
  output_directory = "~/benchmark_demulticoder/mothur_16S_sop/outputs",
...
track_reads_demulticoder<-read.csv("~/benchmark_demulticoder/mothur_16S_sop/outputs/track_reads_r16S.csv", row.names = 1)
...
```{r phyloseq alpha diversity analysis, fig.height=6, fig.width=6}
