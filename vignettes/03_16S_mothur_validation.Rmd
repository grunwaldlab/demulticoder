...
outputs<-prepare_reads(
  data_directory = "~/demulticoder_benchmarking_2/demulticoder_mothur_miseq_sop/data", 
  output_directory = "~/demulticoder_benchmarking_2/demulticoder_mothur_miseq_sop/outputs",
...
tax_matrix<-read.csv("~/demulticoder_benchmarking_2/demulticoder_mothur_miseq_sop/outputs/final_asv_abundance_matrix_r16S.csv")
