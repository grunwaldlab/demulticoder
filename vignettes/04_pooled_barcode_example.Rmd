...
outputs<-prepare_reads(
  ...
  output_directory = "~/demulticoder_benchmarking/demulticoder_combined_analysis_rhode/outputs_newdb_cut50",
  tempdir_path = "~/demulticoder_benchmarking/demulticoder_combined_analysis_rhode/temp_rhode4", 
