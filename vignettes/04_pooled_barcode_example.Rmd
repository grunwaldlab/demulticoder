...
outputs<-prepare_reads(
  ...
  output_directory = "~/demulticoder_benchmarking/demulticoder_combined_analysis_rhode/outputs_olddb_cut", 
  tempdir_path = "~/demulticoder_benchmarking/demulticoder_combined_analysis_rhode/temp_rhode3", 
