...
objs$taxmap_r16S$data$tax_data <-metacoder::calc_obs_props(objs$taxmap_r16S, "otu_table")
...
objs$taxmap_r16S$data$tax_occ <- metacoder::calc_n_samples(objs$taxmap_r16S, "tax_abund", groups = objs$taxmap_r16S$data$sample_data$When, cols = objs$taxmap_r16S$data$sample_data$samplename_barcode)


objs$taxmap_r16S$data$diff_table <- metacoder::compare_groups(objs$taxmap_r16S,
                                      data = "tax_abund",
                                      cols = objs$taxmap_r16S$data$sample_data$samplename_barcode,
                                      groups = objs$taxmap_r16S$data$sample_data$When)
print(objs$taxmap_r16S$data$diff_table)
