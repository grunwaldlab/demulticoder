...
You will see that sample names are unique for 
...
rps10,GTTGGTTAGAGYARAAGACT,ATRYYTAGAAAGAYTYGAACT,FALSE,FALSE,50,TRUE,TRUE,0,5,5,0,0,5,50,Inf,0,0,0,0,15,2,50
its,GTGARTCATCGAATCTTTG,TCCTSCGCTTATTGATATGC,FALSE,FALSE,50,TRUE,TRUE,0,2,2,0,0,5,50,292,0,0,0,0,15,2,50
...
its,GTGARTCATCGAATCTTTG,TCCTSCGCTTATTGATATGC,FALSE,50,TRUE,TRUE,0,2,2,0,0,5,50,292,0,0,0,0,15,2,50
...
### Step 7-convert asv matrix to taxmap and phyloseq objects with one function
...
### Step 10-looks look at a heat tree to see what taxa are more abundant in early vs. late samples, as another means to visualize the data and showcase how easy it is to use taxmap object rather than phylseq object 
```{r heat tree example its, fig.height=6, fig.width=6}
...
### Step 10-looks look at a heat tree to see what taxa are more abundant in early vs. late samples, as another means to visualize the data and showcase how easy it is to use taxmap object rather than phylseq object 
```{r heat tree example, fig.height=6, fig.width=6}
...
### Step 10-looks look at a heat tree to see what taxa are more abundant in early vs. late samples, as another means to visualize the data and showcase how easy it is to use taxmap object rather than phylseq object 
```{r heat tree example rps10, fig.height=6, fig.width=6}
