...
directory_path<-"/Users/masudermann/rps10package/raw_data/rps10" ##choose a directory for all downstream steps
...
obj_dada<-asvmatrix_to_taxmap(asv_abund_matrix, min_read_depth=0, minimum_bootstrap=0)
