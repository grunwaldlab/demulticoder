...
* **tryRC**: If TRUE, the reverse-complement of each sequences will be used for classification if it is a better match to the reference sequences than the forward sequence (default is FALSE)  
...
* UNITE fungal database from [https://zenodo.org/records/14169026](https://zenodo.org/records/14169026)
