...
if (!file.exists(downloaded_read_path)) {
  ...
  utils::download.file(mothur_sop_path, downloaded_read_path, quiet = TRUE)
  ...
  cat("Files already exist here:", downloaded_read_path, "! Skipping download.\n")
}
```
...
if (!file.exists(silva_download_file_path)) {
  utils::download.file(silva_path, silva_download_file_path, quiet = TRUE)
